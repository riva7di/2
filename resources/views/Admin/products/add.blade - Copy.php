            ...
            <form class="form" method="post" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                                    ...
                                    @if (old('variation'))
                                      ...
                                      <div class="col-sm-2 nopadding">
                                         <div class="form-group">
                                           <label for="color" class="col-form-label">{{ trans('labels.color') }}</label>
                                           <select class="form-control" name="color[{{$i}}]" id="color" multiple="">
                                              <option value="">{{ trans('placeholder.select_color') }}</option>
                                              @foreach ($color as $k => $colors)
                                              <option  value="{{ $colors->color_name }}" @if(isset(old('color')[$loop->index])) @if(old('color')[$loop->index] == $colors->color_name) selected @endif @endif>
                                                {{ $colors->color_name }}
                                              </option>
                                      ...
                                      <div class="col-sm-2 nopadding">
                                         <div class="form-group">
                                           ...
                                           <select class="form-control" name="color[]" id="color" multiple="">
                                              ...
                                              <option  value="{{ $colors->color_name }}">{{ $colors->color_name }}</span></span></option>
                                              @endforeach
                                           </select>
                                         </div>
                                      </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title mb-0">Availalabe stock</h6>
                            </div>
                            <div class="card-body">
                                <div class="px-3">
                                    <div class="form-group row">
