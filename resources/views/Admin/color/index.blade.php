                ...
                <div class="col-12">
                    ...
                    <div class="card">                       
                        <div class="card-header">
                            ...
                            <a href="{{route('admin.color.add')}}" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                                {{ trans('labels.add_color') }}
                            </a>
                        </div>
                        
                        <div class="card-body collapse show">
                            <div class="card-block card-dashboard" id="table-display">
                                    @include('Admin.color.colortable')
                            </div>
                        </div>
                    </div>
                </div>
            ...
            if(t.value==true){  
                ...
                $.ajax({
                    ...
                    { 
                        ...
                        {
                            Swal.fire({type: 'error',title: '{{ trans('labels.success') }}',showConfirmButton: false,timer: 1500});
                        }    
                    },error:function(data){
                        $('#preloader').hide();
        ...
        Swal.fire({
            ...
            if(t.value==true){
                ...
                $.ajax({
                    ...
                    url: '{{route("admin.color.changeStatus")}}',
                    type: "POST",
