                ...
                <div class="col-12">
                    ...
                    <div class="card">                       
                        <div class="card-header">
                            ...
                            <a href="{{route('admin.vendors.add')}}" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                                {{ trans('labels.add_vendor') }}
                            </a>
                        </div>

                        <div class="col-md-4">
                            <form method="GET" action="{{route('admin.vendors.search')}}">
