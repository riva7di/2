                ...
                <div class="col-12">
                    ...
                    <div class="card">                       
                        <div class="card-header">
                            <h4 class="card-title">{{ trans('labels.coupons') }}</h4>
                            <a href="{{route('admin.coupons.add')}}" class="btn btn-raised btn-primary btn-min-width mr-1 mb-1 float-right" style="margin-top: -30px;">
                                {{ trans('labels.add_coupons') }}
                            </a>
                        </div>

                        <div class="col-md-4">
                            <form method="GET" action="{{route('admin.coupons.search')}}">
                        ...
                        <div class="card-body collapse show">
                            <div class="card-block card-dashboard" id="table-display">
                                    @include('Admin.coupons.couponstable')
                            </div>
                        </div>
                    </div>
                </div>
