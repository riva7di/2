...
class BottomBannerController extends Controller
{
    ...
    {
        $data = Banner::with('product')->with('category')->where('positions','bottom')->get();
        return view('Admin.bottombanner.index',compact('data'));
    }
    ...
    public function add()
    {
        ...
        return view('Admin.bottombanner.add',compact('data','products'));
    }

    public function list()
    {
    	$data = Banner::with('product')->with('category')->where('positions','bottom')->get();
        return view('Admin.bottombanner.bottombannertable',compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $dataval=array('image'=>$image,'product_id'=>$request->product_id,'cat_id'=>$request->cat_id,'type'=>$request->type,'positions'=>"bottom");
        $data=Banner::create($dataval);
        if ($data) {
             return redirect('admin/bottombanner')->with('success', trans('messages.success'));
        } else {
    ...
    public function show($id)
    {
        ...
        return view('Admin.bottombanner.show',compact('data','category','products'));
    }
